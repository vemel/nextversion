...
function updatePaths(oldVersion, newVersion, paths) {
    for (const path of paths) {
        ...
        fs_1.default.writeFileSync(path, data.replace(oldVersion, newVersion));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const paths = (core.getInput(constants_1.Inputs.Path) || "")
                .split(/\r?\n/)
                .map(x => x.trim());
